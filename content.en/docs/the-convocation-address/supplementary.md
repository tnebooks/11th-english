...
What are all the factors that influence our moods? How do you behave under the spells of different moods? Do you think it is important not to be swayed by every passing mood? Suggest some ways by which we can maintain a calm temperament under all circumstances.
...
"Fast! Ah, too Fast
Fade the Ro-o-ses of Pleasure;
Soon Autumn yields unto Wi-i-ner Drear.
Fleetly! Ah, Fleetly
Mu-u-sic's Gay Measure
...
"We come here To-day
with Flowers o'er laden,
With Baskets of Fruit and
Ribbons to boot,
To-oo Congratulate ...
...
## C. Answer the following in a paragraph of 100 - 150 words each.
...
Direct speech repeats the exact words of the speaker. Reported speech conveys something that was said in the past.

This activity will enable the students to strengthen their knowledge in reported speech.

### Steps:

1. Type the URL link given below in the browser or scan the QR code.
2. Read the Instructions which are given above the video, then watch the video. Find out the reported sentences.
3. Match the direct and indirect speech form.
4. Correct the mistakes in the given sentences and check your answers.
5. You can download and use the resources offline which is given under worksheets and downloads.
